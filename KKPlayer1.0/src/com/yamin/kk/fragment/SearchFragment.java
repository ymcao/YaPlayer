...
import com.yamin.kk.adapter.SearchHistoryAdapter;
import com.yamin.kk.adapter.SearchResultAdapter;
...
public class SearchFragment extends SherlockListFragment {
    ...
    public final static String TAG = "KKY/SearchActivity";
    ...
    private void showListHeader(String text) {
        MyListView lv = (MyListView) getListView();
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        if (getListAdapter() == mHistoryAdapter) {
            String selection = ((TextView) v.findViewById(R.id.list_item1_textview)).getText().toString();
